...
import by.it_academy.jd2.voting.my_voting.dto.TextAboutCounter;
...
public class TextAboutResultServlet extends HttpServlet {
    ...
    private IVoteCounter<LocalDateTime, String> counter = new TextAboutCounter(VoteContainer.getInstance());
